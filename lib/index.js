      ...
      return buttons.map(function (buttonContent, index) {
        ...
        var transform = [{
          translateX: pan.x.interpolate({
            inputRange: _this2._getTextDirectionDependentValue([canSwipeLeft ? -width : 0, canSwipeRight ? width : 0], [canSwipeLeft ? 0 : -width, canSwipeRight ? 0 : width]),
            outputRange: _this2._getTextDirectionDependentValue([canSwipeLeft ? -width + _reactNative.StyleSheet.hairlineWidth : 0, canSwipeRight ? width - _reactNative.StyleSheet.hairlineWidth : 0], [canSwipeLeft ? 0 : -width + _reactNative.StyleSheet.hairlineWidth, canSwipeRight ? 0 : width - _reactNative.StyleSheet.hairlineWidth]),
            extrapolate: "clamp"
          })
        }];
